...
[select rows=4 tts=0] SELECT t0.AccountNum, t0.Party, t0.CustGroup, t0.CurrencyCode, t0.PaymTermId, t0.CreditMax, t0.Blocked, t0.DefaultDimension, t0.RECID, t0.DATAAREAID FROM CustTable AS t0 WHERE (t0.AccountNum LIKE ?) AND t0.DATAAREAID = ?  -- ["C-%","HVND"]
