...
[update rows=1 tts=1] UPDATE InventTable SET ItemId = ?, ItemName = ?, ItemGroupId = ?, ItemType = ?, Blocked = ?, StandardCost = ?, DefaultDimension = ? WHERE RECID = ?  -- ["F-100","Renamed desk","FURNITURE",0,0,184.5,6302,1]
